...
<?php
    ...
    //checking whether the transaction amount is more than zero. If not, show error.
    else if ($amount <= 0){
        $message = 'ERROR : Enter amount above zero.';
    }
    ...
    echo '<div class = "h-row">
            <a href = "profile.php?customers=' . $id1 . '" class = "h-button">Go Back</a>
